...
The licenses of [DrawKit](https://www.drawkit.com/license) and [unDraw](https://undraw.co/license) allows the use of their images for visual improvements only.

unDraw allows for direct download of images, as `svg` or `png`. DrawKit requires an e-mail where they will send the download link for the selected set of images.
